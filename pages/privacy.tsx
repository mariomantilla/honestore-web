    ...
    return (<>
        ...
        <PolicyPage title="Política de Privacidad" lastEdit="28/03/2023" desc="Tu privacidad es importante para nosotros. En esta página te contamos qué datos recopilamos, que hacemos con ellos y cúales son tus derechos al respecto.">
            <Policy title="Ámbito" id="scope">
                ...
                <Typography>
                    Por favor ten en cuenta que cuando nos envías información a través de sitios o plataformas de terceros
            ...
            <Policy title="¿Qué información recogemos?" id="collectedInfo">
                ...
                <b>Sitio web honestore.app y Applicación móvil Honestore</b>
                <ul>
                    <li>Información de registro cuando creas una cuenta en Honestore como tu email, nombre y contraseña.</li>
                    <li>
                ...
                <ul>
                    <li>
                        Información de contacto como email y nombre de usuario que quieren
                ...
                <Typography>
                    <b>Nota:</b> Sólo utilizamos cookies para mantenerte identificado como usuario cuando inicias sesión.
                    Por ello te pedimos que leas y aceptes esta política antes de iniciar sesión o registrarte. No utilzamos
                    cookies de rastreo para publicidad.
                </Typography>
            ...
            <Policy title="¿Cómo recogemos la información?" id="how">
                ...
                <ul>
                    <li>Formularios dentro de la applicación o web (cuando te registras)</li>
                    <li>
            ...
            <Policy title="Derechos y decisiones" id="rights">
                ...
                <Typography>
                    ...
                    de oposición (art. 21), a presentar una reclamación ante una autoridad de control (art. 77) y
            ...
            <Policy title="Seguridad de los datos" id="security">
                <Typography>
                    Los datos que nos envías a través de la aplicación están almacenados en Europa y no se transfieren en ningún
            ...
            <Policy title="Cambios en esta política" id="changes">
                <Typography>
                    ...
                    Te informaremos de dichos cambios en caso de haberlos y si son cambios importantes o la ley lo requiere te pediremos
